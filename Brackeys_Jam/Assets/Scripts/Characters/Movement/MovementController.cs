...
namespace StarterAssets
{
    ...
    public class MovementController : MonoBehaviour
    {
        ...
        [Tooltip("Should the movement be curved to give a more natural path?")]
        ...
        protected MovementInputs _input;
        ...
        protected virtual void Move()
        {
                ...
                currentHorizontalSpeed > targetSpeed + speedOffset)
            {
                ...
                _speed = lerpMovement ? Mathf.Lerp(currentHorizontalSpeed, targetSpeed * inputMagnitude,
                    Time.deltaTime * SpeedChangeRate) : targetSpeed * inputMagnitude;
